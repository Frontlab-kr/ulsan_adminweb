...
//Pub
import Pub from '../pages/Pub/index';
import UlWebLogin01 from '../pages/Pub/UL-WEB-LOGIN-01';
import UlWebDash01 from '../pages/Pub/UL-WEB-DASH-01';
import WebStat01 from '../pages/Pub/WEB-STAT-01';

import UlWebUser01 from '../pages/Pub/UL-WEB-USER-01';
import UlWebMng01 from '../pages/Pub/UL-WEB-MNG-01';
import UlWebMng02 from '../pages/Pub/UL-WEB-MNG-02';
import UlWebMng03 from '../pages/Pub/UL-WEB-MNG-03';
import UlWebMng04 from '../pages/Pub/UL-WEB-MNG-04';

const authProtectedRoutes = [
  { path: '/PUB/', component: <Pub /> },

  { path: '/UL-WEB-DASH-01', component: <UlWebDash01 /> },
  { path: '/WEB-STAT-01', component: <WebStat01 /> },
  { path: '/UL-WEB-USER-01', component: <UlWebUser01 /> },
  { path: '/UL-WEB-MNG-01', component: <UlWebMng01 /> },
  { path: '/UL-WEB-MNG-02', component: <UlWebMng02 /> },
  { path: '/UL-WEB-MNG-03', component: <UlWebMng03 /> },
  { path: '/UL-WEB-MNG-04', component: <UlWebMng04 /> },
...
const publicRoutes = [
  // Pub
  { path: '/UL-WEB-LOGIN-01', component: <UlWebLogin01 /> },
